...
test26 :: IO ()
test26 = applyTransformation Atbash (prettyRead "אבגדהוזחטיכלמנסעפצקרשת") @?= prettyRead "תשרקצפעסנמלכיטחזוהדגבא"

test27 :: IO ()
test27 = applyTransformation Achbi (prettyRead "אבגדהוזחטיכלמנסעפצקרשת") @?= prettyRead "כיטחזוהדגבאתשרקצפעסנמל"

test28 :: IO ()
test28 = applyTransformation Avgad (prettyRead "אבגדהוזחטיכלמנסעפצקרשת") @?= prettyRead "בגדהוזחטיכלמנסעפצקרשתא"

test29 :: IO ()
test29 = applyTransformation Albam (prettyRead "אבגדהוזחטיכלמנסעפצקרשת") @?= prettyRead "למנסעפצקרשתאבגדהוזחטיכ"

test30 :: IO ()
test30 = applyTransformation Ofanim (prettyRead "אבגדהוזחטיכלמנסעפצקרשת") @?= prettyRead "ףתלתאוןתתדףדםןךןאיףשןו"
